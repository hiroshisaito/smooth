...
公開日: TBD(出荷時に追記)
リポジトリ HEAD: TBD(Mac / Windows それぞれの binary embedded build-id を出荷時に追記)
...
| ファイル | 対象 | サイズ | SHA256 |
| --- | --- | --- | --- |
| `smooth.Mac.1.6.0.AE2025.universal.zip` | Apple Silicon + Intel 両対応 | TBD | TBD |
| `smooth.Mac.1.6.0.AE2025.arm64.zip`     | Apple Silicon 専用           | TBD | TBD |
| `smooth.Mac.1.6.0.AE2025.x86_64.zip`    | Intel 専用                  | TBD | TBD |
...
| ファイル | 対象 | サイズ | SHA256 |
| --- | --- | --- | --- |
| `smooth.Win.1.6.0.AE2025.x64.zip` | Windows x64 | TBD | TBD |
