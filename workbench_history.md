...
- 実機検証(Mac AE 2025 で 32bpc プロジェクト作成 → 黄色三角が消える + 出力が visually 妥当)は Step 5 の cross-platform 検証で実施。Step 2 は build + Rust unit + 8/16bpc regression の 3 層で gate 通過とする。
